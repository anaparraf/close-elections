...
close_elections_final = elections_final |> 
  filter(margem_vitoria_mulher <= 0.134/2 & margem_vitoria_mulher >= -0.134/2)
...
rdrobust(y = elections_final$tx_homicidio, x = elections_final$margem_vitoria_mulher, c = 0, h= 0.134) |> summary()
